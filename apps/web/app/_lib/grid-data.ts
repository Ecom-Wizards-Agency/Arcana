 ...
 *    This is the same rule the recon says to clone (`https://github.com/Ecom-Wizards-Agency/openspell/blob/1ca9bd7c253e2a3f6b8c8b5848ee7bfad695781f/tools/recon/02-data-grid.md` §4), held
...
export interface LoadGridOptions {
   ...
   * pagination, which is the point (`https://github.com/Ecom-Wizards-Agency/openspell/blob/1ca9bd7c253e2a3f6b8c8b5848ee7bfad695781f/tools/recon/02-data-grid.md` §6) -- but "no pagination"
