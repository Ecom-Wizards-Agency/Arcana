import { descriptor } from '../../src/screens/sponsored-prompts/redirect/descriptor';
...
export default async function Page({ searchParams, params }: { searchParams?: Promise<ScreenSearchParams>; params?: Promise<Record<string, string>> } = {}) {
  const [data, Screen] = await Promise.all([pageRead(descriptor, searchParams, params), descriptor.client()]);
