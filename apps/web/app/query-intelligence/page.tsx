...
import { pageReadErrorMessage } from '../../src/server/authenticated-page-read';
...
export default async function QueryIntelligencePage({
  ...
  try {
    ...
    try {
      return await withAuthenticatedReadSnapshot(database, actor, async (snapshot) => {
