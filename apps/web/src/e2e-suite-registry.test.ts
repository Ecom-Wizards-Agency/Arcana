...
describe('web E2E suite registry', () => {
  ...
  it('conserves all 77 logical test cases and resolves every dispatch entry', () => {
    expect(E2E_SUITE_DEFINITIONS.reduce((total, suite) => total + suite.expectedTests, 0)).toBe(77);
