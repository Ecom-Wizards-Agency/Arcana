...
import Loading from '../../../app/tags/loading';
import { verifyScreen } from '../settings/render-support';
import SharedError from '../../../app/tags/error';
...
verifyScreen(descriptor, [
  ...
  { state: 'empty', name: 'explains the absence of tags', render: () => <Screen data={ready} />, text: 'No tags yet.' },
  { state: 'ready', name: 'renders the screen with synthetic data', render: () => <Screen data={ready} />, text: "Nested tags" },
