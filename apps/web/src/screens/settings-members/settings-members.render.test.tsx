...
import Loading from '../../../app/settings/members/loading';
import { verifyScreen } from '../settings/render-support';
import SharedError from '../../../app/settings/members/error';
...
verifyScreen(descriptor, [
  { state: 'empty', name: 'renders the empty collection', render: () => <Screen data={ready} />, text: "No pending invitations" },
  ...
  { state: 'ready', name: 'renders the screen with synthetic data', render: () => <Screen data={ready} />, text: "Members" },
