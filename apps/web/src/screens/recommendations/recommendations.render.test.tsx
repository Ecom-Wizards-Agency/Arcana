...
import Loading from '../../../app/recommendations/loading';
import { verifyScreen } from '../settings/render-support';
import SharedError from '../../../app/recommendations/error';
...
verifyScreen(descriptor, [
  ...
  { state: 'ready', name: 'renders the screen with synthetic data', render: () => <Screen data={ready} />, text: "Recommendations" },
  ...
  { state: 'not-measured', name: 'does not substitute measured results for absent evidence', render: () => <Screen data={ready} />, text: "No recommendations run yet" }
]);
