...
export const descriptor = {
  ...
  load: (actor, params) => import('./load').then((module) => module.loadWithObservation(actor, params)),
  client: (): Promise<typeof ScreenView> => import('./view').then((module) => module.default),
} satisfies ScreenDescriptor<Awaited<ReturnType<typeof loadWithObservation>>>;
