...
export function GroupPerformance({ performance, currency }: { performance: OptimizationGroupPerformance; currency: string; profileId: string }) {
  ...
  return <><div className={styles.actions}>
    <label><input type="checkbox" checked={compare} onChange={(event) => setCompare(event.target.checked)} /> Compare previous period</label></div>
