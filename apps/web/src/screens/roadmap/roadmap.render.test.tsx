...
import Loading from '../../../app/roadmap/loading';
import { verifyScreen } from '../settings/render-support';
import SharedError from '../../../app/roadmap/error';
...
verifyScreen(descriptor, [
  ...
  { state: 'ready', name: 'renders the screen with synthetic data', render: () => <Screen data={ready} />, text: "Roadmap" },
  ...
  { state: 'empty', name: 'shows the empty workspace', render: () => <Screen data={ready} />, text: "Roadmap" }
]);
