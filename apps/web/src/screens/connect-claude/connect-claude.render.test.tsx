...
import Loading from '../../../app/connect-claude/loading';
import { verifyScreen } from '../settings/render-support';
import SharedError from '../../../app/connect-claude/error';
...
verifyScreen(descriptor, [
  { state: 'empty', name: 'renders the empty collection', render: () => <Screen data={ready} />, text: "No keys yet." },
  ...
  { state: 'ready', name: 'renders the screen with synthetic data', render: () => <Screen data={ready} />, text: "Connect AI" },
