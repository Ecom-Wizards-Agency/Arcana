...
export const E2E_SUITE_DEFINITIONS = [
  ...
  {
    name: 'auth-guards-anonymous-a',
    kind: 'authenticated-dev',
    config: 'playwright.auth-guards-anonymous-a.config.ts',
    project: 'auth-guards-anonymous-a',
    expectedSpecFiles: specsFor('auth-guards-anonymous-a'),
    expectedTests: 2,
  },
  {
    name: 'auth-guards-anonymous-b',
    kind: 'authenticated-dev',
    config: 'playwright.auth-guards-anonymous-b.config.ts',
    project: 'auth-guards-anonymous-b',
    expectedSpecFiles: specsFor('auth-guards-anonymous-b'),
    expectedTests: 1,
  },
  {
    name: 'auth-guards-signed-in-a',
    kind: 'authenticated-dev',
    config: 'playwright.auth-guards-signed-in-a.config.ts',
    project: 'auth-guards-signed-in-a',
    expectedSpecFiles: specsFor('auth-guards-signed-in-a'),
    expectedTests: 2,
  },
  {
    name: 'auth-guards-signed-in-b',
    kind: 'authenticated-dev',
    config: 'playwright.auth-guards-signed-in-b.config.ts',
    project: 'auth-guards-signed-in-b',
    expectedSpecFiles: specsFor('auth-guards-signed-in-b'),
    expectedTests: 2,
  },
  {
    name: 'auth',
