...
export const PACKAGE_REGISTRY: readonly RegistryEntry[] = [
  ...
  {domain: 'schema/own-collectors', contract: null, schema: 'schema/own-collectors.ts', queries: null, migrationPrefix: '20260915280000', exports: [{barrel: 'schema/index.ts', order: 110, clause: '*', after: ''}]},
  {domain: 'queries/own-collectors', contract: null, schema: null, queries: 'queries/own-collectors.ts', migrationPrefix: '20260915290000', exports: [
    ...
    {barrel: 'worker.ts', order: 10, clause: '{ OwnCollectorConflictError, collectorProfile, readOwnBidMirrors, readOwnListingAsins, readCollectorExports, persistEffectiveBidObservations, persistListingSnapshots }', after: ''}]},
