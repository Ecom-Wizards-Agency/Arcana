...
export const PACKAGE_REGISTRY: readonly RegistryEntry[] = [
  ...
  {"domain": "queries/sp-write-persistence", "contract": null, "schema": null, "queries": "queries/sp-write-persistence.ts", "migrationPrefix": null, "exports": [{"barrel": "sp-write-persistence.ts", "order": 0, "clause": "*", "after": ""}]},
