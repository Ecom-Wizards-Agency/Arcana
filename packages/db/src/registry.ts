...
export const PACKAGE_REGISTRY: readonly RegistryEntry[] = [
  ...
  { domain: 'queries/campaign-creation-batches', contract: null, schema: null, queries: 'queries/campaign-creation-batches.ts', migrationPrefix: '20260915370000', exports: [{ barrel: 'index.ts', order: 290, clause: '{ readCampaignCreationBatch, findCampaignCreationAdmission, listCampaignCreationBatches, readCampaignCreationProviderScope, readCampaignCreationGate, admitCampaignCreation, recordCampaignCreationRetryReview, CampaignCreationAdmissionError }', after: '' }] },
