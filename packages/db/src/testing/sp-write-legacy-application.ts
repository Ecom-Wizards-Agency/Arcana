/** Archived compatibility helpers for synthetic regression and inverse proofs only. */
...
export { readRecordedSpWritePreview } from '../queries/sp-write-recorded-preview.js';
