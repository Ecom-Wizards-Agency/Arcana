...
import { approveAndQueueSpWrite, previewSpWrite } from './testing/sp-write-legacy-application.js';
  ...
  async function fixture() {
    ...
    await database.sql`insert into public.recommendations
      ...
      values (${recommendationId}, ${runId}, ${orgId}, ${profileId}, 'high_acos', 'keyword', 'kw-1',
        'bid', '0.9'::jsonb, '0.7'::jsonb, ${JSON.stringify(syntheticRecommendationMethodInputs())}::jsonb, 'accepted')`;
